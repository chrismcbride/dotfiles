...
export PATH=/usr/local/bin:/usr/local/sbin/:/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/games:/usr/games:/opt/java/bin:~/bin:/usr/bin/vendor_perl:~/.gem/ruby/1.9.1/bin/:~/.gem/ruby/2.0.0/bin:$GOPATH/bin
